...
import CalenderCard from "../assets/banner-2.png";

export default function HeroSection() {
  return (
    <div className="max-w-7xl mx-auto grid grid-cols-2 justify-between">
      <div className="py-44">
        <h5 className="text-xl text-current_color font-handle ">
          Welcome To Our Company
        </h5>
        <h1 className="text-8xl font-semibold pt- pb-10 text-secondary_color tracking-tight leading- font-playfair">
        ...
        <p className="text-neutral-600 pl-4 text-lg relative after:absolute after:left-0 after:top-0 after:h-full after:w-0.5 after:bg-secondary">
          When we say we’re not happy until you’re happy, we really do mean it.
          You <br /> will be happy with service.
        </p>
        <div className="">
