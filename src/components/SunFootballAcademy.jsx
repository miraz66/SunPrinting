      ...
      <div className="bg-gray-900 pt-72 pb-40 bg-opacity-65">
        <div className="max-w-7xl mx-auto px-5">
          <div>
            ...
            >
              <p>
                Sun Sporting Club is a premier sports organization dedicated to
                fostering a culture of athleticism, teamwork, and community
              ...
              <ul className="pl-6 space-y-5 text-lg">
                <li>
                  <strong>1. Comprehensive Sports Programs:</strong> We offer a
                  wide range of sports programs for athletes of all ages and
                  skill levels, including soccer, basketball, volleyball,
                  tennis, swimming, and more. Whether you're a beginner looking
                  to learn the basics or a seasoned athlete aiming for elite
                  competition, we have programs tailored to your needs.
                </li>
                <li>
                  <strong>2. Professional Coaching: </strong>
                  Our experienced coaches are dedicated to helping athletes
                  reach their full potential. With a focus on skill development,
                  tactical understanding, and physical conditioning, our coaches
                  provide personalized training and guidance to help athletes
                ...
                <li>
                  ...
                  modern amenities and training equipment. From well-maintained
                  fields and courts to Olympic-sized swimming pools, our
                  facilities provide the perfect environment for athletes to
                ...
                <li>
                  ...
                  charity events, and partnerships with local organizations, we
                  strive to give back and support the communities we serve.
                </li>
              </ul>
