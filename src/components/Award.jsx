...
export default function Award() {
  return (
    <>
          ...
          <div className="grid grid-cols-3 gap-8">
            {AwardData.map(({ date, icon, img, description }) => (
              <div key={date} className="relative rounded-t-xl mt-40 shadow-lg">
                ...
                <img className="rounded-t-xl" src={img} alt="Award image" />
                <div className="relative bg-white">
                  {icon}
                  <p className="text-2xl pt-20 py-16 px-16 tracking-wide font-playfair font-bold">
                    {description}
                  </p>
                </div>
              </div>
      ...
      <div className="h-[20rem] bg-red-white">
        <div className="mt-96 max-w-7xl mx-auto text-secondary_color">
